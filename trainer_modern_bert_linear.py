...
from module import LinearBEModel
...
study_name = "bert-modern-finetune-linear"  # Unique identifier of the study.
...
def objective(trial: optuna.trial.Trial) -> float:
    ...
    # ## LightningModule ## #
    lit_module = LinearBEModel(learning_rate=lr, learning_rate_bert=lr, attention_probs_dropout=0.1, 
    ...
    lit_trainer = pl.Trainer(
        ...
        max_epochs=MAXEPOCH,
        logger=[csvlogger, CometLogger(api_key="YOUR_COMET_API_KEY", project_name="bert-modern-linear-tweets-disasters",), DVCLiveLogger(save_dvc_exp=True)],
        # logger=[csvlogger],
        callbacks=callbacks,
